  ...
  'inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        outlinePrimary:
          'border text-dark-400 border-primary-300 dark:border-primary-900 hover:bg-primary-100/50 dark:hover:bg-primary-900',
        outlineSecondary:
        ...
        primary:
          'bg-primary-300/70 text-dark-400 hover:bg-primary-300/90 dark:bg-primary-700 dark:hover:bg-primary-700/90',
        secondary:
