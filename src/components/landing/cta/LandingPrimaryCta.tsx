...
const LandingPrimaryCtaContent = ({
  ...
  return (
    ...
    >
      ...
      {title ? (
        <h1 className="text-4xl lg:text-5xl lg:leading-14 font-semibold md:max-w-xl text-black dark:text-white">
          {title}
        </h1>
      ) : (
        titleComponent
      ...
      {description ? (
        <p className="md:text-lg md:max-w-lg text-dark-400">{description}</p>
      ) : (
        descriptionComponent
      )}
