  ...
  return (
    ...
    >
      ...
      <div className={clsx(className, 'w-full p-6 container-narrow')}>
        {title ? (
          <h2 className="text-3xl text-dark-400 font-semibold leading-tight max-w-xs sm:max-w-none md:text-4xl lg:text-5xl fancyHeading">
            {title}
          </h2>
        ) : (
          titleComponent
        ...
        {description ? (
          <p className="mt-6 md:text-xl text-dark-400">{description}</p>
        ) : (
          descriptionComponent
        )}
        ...
        >
          {faqItems.map((faqItem, index) => (
            ...
            >
              <AccordionTrigger className="text-left text-dark-400">
                {faqItem.question}
              </AccordionTrigger>
              <AccordionContent className="text-dark-400">{faqItem.answer}</AccordionContent>
            </AccordionItem>
          ))}
        </Accordion>
      </div>
